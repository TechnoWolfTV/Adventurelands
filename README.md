...
Add hoppers and assorted automation helpers, and you can take a base from hand-mined hole to self-running factory.
...
Whether you are after a brick mansion, a patio bar, a cosy cabin, or a sprawling castle, the parts are there.
...
As your world grows, so does the need to cross it quickly. Adventurelands provides several options: ride a tamed horse, glide from heights with a hang glider, hop aboard boats and carts, or set up teleportation networks with travelnets and teleport pads to link your bases together. Crossing the map becomes part of the fun rather than a chore.
...
Found a problem or have a suggestion? Please open an issue on the [issue tracker](https://github.com/TechnoWolfTV/Adventurelands/issues). Clear reports — what you did, what happened, and what you expected — are the most helpful, and the maintenance state is active, so feedback is welcome.
