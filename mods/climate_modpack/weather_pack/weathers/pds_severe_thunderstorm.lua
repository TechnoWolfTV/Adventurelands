...
local WIND_PEAK  = 3.5   -- multiplier sustained through onslaught (higher than severe_thunderstorm: pds onslaught is longer/darker/noisier, so wind needs more punch to read)
